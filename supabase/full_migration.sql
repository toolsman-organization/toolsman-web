-- ============================================================
-- TOOLSMAN — COMPLETE DATABASE SETUP & SEED MIGRATION
...
-- ============================================================
-- 2. CORE TABLE: PROFILES (Must be created before is_admin function)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS public.orders (
  ...
  order_status         TEXT NOT NULL DEFAULT 'awaiting_payment' CHECK (order_status IN ('pending', 'awaiting_payment', 'confirmed', 'processing', 'packed', 'shipped', 'delivered', 'cancelled')),
...
-- Order auto number & status tracking functions & triggers
