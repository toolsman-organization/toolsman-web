...
export default function TrustSection() {
  return (
    <section className="py-8 sm:py-10 bg-neutral-950 text-white border-y border-neutral-800">
      <div className="container-site">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          {trustFeatures.map((feature, idx) => (
            <div
              key={idx}
              className="flex items-start gap-4 p-4 rounded-xl bg-neutral-900/60 border border-neutral-800/80 hover:border-orange-500/40 transition-colors"
            >
              <div className="p-2.5 rounded-lg bg-neutral-800/80 flex items-center justify-center shrink-0">
                {feature.icon}
              </div>
